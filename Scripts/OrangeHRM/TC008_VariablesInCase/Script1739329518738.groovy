...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Username_oxd-input oxd-input--focus'), search1)
...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Employee Id_oxd-input oxd-input--focus'), search2)
...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input'), search3)

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_Required View'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/span_Recruitment'))

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_1'), search4)

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_Keywords'))
